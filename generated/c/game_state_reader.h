...
__flatbuffers_define_scalar_field(4, Projectile, size, flatbuffers_float, float, 0.00000000f)
__flatbuffers_define_scalar_field(5, Projectile, damage, flatbuffers_float, float, 0.00000000f)
...
__flatbuffers_define_vector_field(2, GameStateDelta, dead_entities, flatbuffers_uint64_vec_t, 0)
__flatbuffers_define_vector_field(3, GameStateDelta, entity_positions, EntityUpdate_vec_t, 0)
